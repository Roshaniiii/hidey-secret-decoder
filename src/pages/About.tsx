import { Lock, Shield, Sparkles, MessageSquare, ListChecks, HelpCircle, AlertTriangle } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/20 to-secondary/20">
      <div className="container max-w-4xl mx-auto px-4 py-12 space-y-10">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-5xl font-bold text-foreground tracking-tight">About Hidey</h1>
        ...
        {/* Description */}
        <Card className="p-6 bg-card border-2 border-border rounded-2xl shadow-lg space-y-3">
          <h2 className="text-2xl font-bold text-foreground flex items-center gap-2">
            <Sparkles className="h-6 w-6 text-primary" /> What is Hidey?
          </h2>
        ...
        <div className="space-y-4">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <Card className="p-5 bg-card border-2 border-border rounded-2xl text-center space-y-2">
              <div className="inline-block p-2 bg-primary/20 rounded-xl">
                <MessageSquare className="h-6 w-6 text-primary" />
              </div>
              <h3 className="font-bold text-foreground">Message Mode</h3>
              <p className="text-sm text-muted-foreground">Encode and decode secret messages using customizable alphabet patterns and optional passphrases.</p>
            </Card>
            <Card className="p-5 bg-card border-2 border-border rounded-2xl text-center space-y-2">
              <div className="inline-block p-2 bg-secondary/40 rounded-xl">
                <ListChecks className="h-6 w-6 text-secondary-foreground" />
              </div>
              <h3 className="font-bold text-foreground">Quiz Mode</h3>
              <p className="text-sm text-muted-foreground">Create MCQ quizzes, share them as compact codes, and let others attempt and reveal scores.</p>
            </Card>
            <Card className="p-5 bg-card border-2 border-border rounded-2xl text-center space-y-2">
              <div className="inline-block p-2 bg-accent rounded-xl">
                <HelpCircle className="h-6 w-6 text-accent-foreground" />
              </div>
              <h3 className="font-bold text-foreground">Question Mode</h3>
              <p className="text-sm text-muted-foreground">Hide a message behind a question — the answer is the key to unlock it.</p>
            </Card>
          </div>
        </div>
        ...
        <Card className="p-6 bg-card border-2 border-border rounded-2xl shadow-lg space-y-3">
          <h2 className="text-2xl font-bold text-foreground flex items-center gap-2">
            <Shield className="h-6 w-6 text-primary" /> Our Mission
          </h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        {/* Safety Note */}
        <Card className="p-6 bg-destructive/10 border-2 border-destructive/30 rounded-2xl space-y-3">
          <h2 className="text-xl font-bold text-foreground flex items-center gap-2">
            <AlertTriangle className="h-5 w-5 text-destructive" /> Safety Note
          </h2>
          <p className="text-muted-foreground leading-relaxed">
