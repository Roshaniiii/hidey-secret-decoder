...
const PrivacyPolicy = () => {
  useEffect(() => {
    ...
    document.title = "Privacy Policy — Hidey";

    const metaName = "description";
    const content =
      "Read Hidey's Privacy Policy — learn how we handle data on our free, browser-based secret message and quiz tool.";
    ...
    <main className="min-h-screen bg-gradient-to-br from-background via-accent/20 to-secondary/20 animate-in fade-in duration-500 scroll-smooth">
      <div className="container max-w-4xl mx-auto px-4 py-12 space-y-10">
          ...
          <Card className="rounded-2xl border-2 border-border shadow-lg p-6 sm:p-10 max-w-[800px] mx-auto">
            <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-3">
                <h2 className="font-semibold text-foreground text-lg">Interpretation and Definitions</h2>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li><strong className="text-foreground">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Hidey.</li>
                  ...
                  <li><strong className="text-foreground">Country</strong> refers to: Chandigarh, India</li>
                  ...
                  <li><strong className="text-foreground">Website</strong> refers to Hidey, accessible from <a href="https://hideyy.lovable.app/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://hideyy.lovable.app/</a></li>
              ...
              <section className="space-y-3">
                <h2 className="font-semibold text-foreground text-lg">Collecting and Using Your Personal Data</h2>
                ...
                <h4 className="font-semibold text-foreground">Tracking Technologies and Cookies</h4>
                <p>
                ...
                <p>
                  ...
                  consent at any time using Our cookie preferences tool (if available) or through
                  Your browser/device settings. Withdrawing consent does not affect the lawfulness of
                ...
                <div className="space-y-3 pl-2">
                  <div>
                    <p className="font-semibold text-foreground">Necessary / Essential Cookies</p>
                    <p>Type: Session Cookies</p>
                    <p>Administered by: Us</p>
                    <p>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                  </div>
                  <div>
                    <p className="font-semibold text-foreground">Cookies Policy / Notice Acceptance Cookies</p>
                    <p>Type: Persistent Cookies</p>
                    <p>Administered by: Us</p>
                    <p>Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
                  </div>
                  <div>
                    <p className="font-semibold text-foreground">Functionality Cookies</p>
                    <p>Type: Persistent Cookies</p>
                    <p>Administered by: Us</p>
                ...
                <h3 className="font-semibold text-foreground">Retention of Your Personal Data</h3>
                <p>
                ...
                <h3 className="font-semibold text-foreground">Transfer of Your Personal Data</h3>
                <p>
                ...
                <p>
                  ...
                  Your Personal Data are subject to appropriate safeguards and supplementary measures
                  where appropriate. The Company will take all steps reasonably necessary to ensure
                  that Your data is treated securely and in accordance with this Privacy Policy and
                  no transfer of Your Personal Data will take place to an organization or a country
                  unless there are adequate controls in place including the security of Your data and
                  other personal information.
                </p>

                <h3 className="font-semibold text-foreground">Delete Your Personal Data</h3>
                ...
                <h3 className="font-semibold text-foreground">Disclosure of Your Personal Data</h3>
                <h4 className="font-semibold text-foreground">Business Transactions</h4>
                ...
                <h4 className="font-semibold text-foreground">Other legal requirements</h4>
                ...
                <h3 className="font-semibold text-foreground">Security of Your Personal Data</h3>
                <p>
              ...
              <section className="space-y-2">
                <h2 className="font-semibold text-foreground text-lg">Links to Other Websites</h2>
                <p>
              ...
              <section className="space-y-2">
                <h2 className="font-semibold text-foreground text-lg">Changes to this Privacy Policy</h2>
                <p>
              ...
              <section className="space-y-3">
                <h2 className="font-semibold text-foreground text-lg">Contact Us</h2>
        ...
        <p className="text-center text-xs text-muted-foreground">
          © 2026 Hidey. All rights reserved. |{" "}
