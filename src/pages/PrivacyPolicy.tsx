            ...
            <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li><strong className="text-foreground">Website</strong> refers to tryhidey.xyz, accessible from <a href="https://tryhidey.xyz" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://tryhidey.xyz</a></li>
